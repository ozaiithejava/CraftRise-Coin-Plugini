...
public class DatabaseManager2 {
    ...
    public DatabaseManager2(Expercoins expercoins, ConfigManager configManager) {
        ...
        this.tableName = configManager.getString("mysql.table2");
    ...
    public  void createTable() {
        try {
            ...
            String query = "CREATE TABLE IF NOT EXISTS rewards (id INT AUTO_INCREMENT PRIMARY KEY,player VARCHAR(255) NOT NULL,reward_type VARCHAR(255) NOT NULL,claimed TINYINT(1) NOT NULL,claimed_date BIGINT(20) NOT NULL)";
